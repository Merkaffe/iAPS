...
//  OmniTests
//
//  From OmniBLE/OmniBLETests/ZeroBasalScheduleTests.swift
...
class ZeroBasalScheduleTests: XCTestCase {
    ...
    func testZeroOneZeroSegment() {
        let entries = [
            BasalScheduleEntry(rate:  1.00, startTime: .hours(0), zeroBasalRate: Pod.nearZeroBasalRate),
            BasalScheduleEntry(rate:  0.00, startTime: .hours(0.5), zeroBasalRate: Pod.nearZeroBasalRate),
            BasalScheduleEntry(rate:  1.00, startTime: .hours(1.0), zeroBasalRate: Pod.nearZeroBasalRate),
            ]
        ...
        let cmd2 = BasalScheduleExtraCommand(schedule: schedule, scheduleOffset: offset, acknowledgementBeep: false, completionBeep: true, programReminderInterval: 0, zeroBasalRate: Pod.nearZeroBasalRate)
    ...
    func testZeroMinBasal() {
        let entries = [
            BasalScheduleEntry(rate:  0.00, startTime: .hours(0), zeroBasalRate: Pod.nearZeroBasalRate),
            BasalScheduleEntry(rate:  0.05, startTime: .hours(23), zeroBasalRate: Pod.nearZeroBasalRate),
            ]
    ...
    func testZeroSomeZeroBasal() {
        let entries = [
            BasalScheduleEntry(rate:  1.05, startTime: .hours(0), zeroBasalRate: Pod.nearZeroBasalRate),
            BasalScheduleEntry(rate:  0.00, startTime: .hours(6), zeroBasalRate: Pod.nearZeroBasalRate),
            BasalScheduleEntry(rate:  0.75, startTime: .hours(7.5), zeroBasalRate: Pod.nearZeroBasalRate),
            BasalScheduleEntry(rate:  0.85, startTime: .hours(9), zeroBasalRate: Pod.nearZeroBasalRate),
            BasalScheduleEntry(rate:  0.65, startTime: .hours(9.5), zeroBasalRate: Pod.nearZeroBasalRate),
            BasalScheduleEntry(rate:  0.00, startTime: .hours(13.5), zeroBasalRate: Pod.nearZeroBasalRate),
            BasalScheduleEntry(rate:  0.10, startTime: .hours(15.5), zeroBasalRate: Pod.nearZeroBasalRate),
            BasalScheduleEntry(rate:  0.05, startTime: .hours(17), zeroBasalRate: Pod.nearZeroBasalRate),
            BasalScheduleEntry(rate:  0.20, startTime: .hours(19.5), zeroBasalRate: Pod.nearZeroBasalRate),
            BasalScheduleEntry(rate:  0.35, startTime: .hours(21), zeroBasalRate: Pod.nearZeroBasalRate),
            BasalScheduleEntry(rate:  2.75, startTime: .hours(22.5), zeroBasalRate: Pod.nearZeroBasalRate),
            ]
    ...
    func testZeroBasalTest1() {
        let entries = [
            BasalScheduleEntry(rate:  0.00, startTime: .hours(0), zeroBasalRate: Pod.nearZeroBasalRate),
            BasalScheduleEntry(rate:  0.05, startTime: .hours(1), zeroBasalRate: Pod.nearZeroBasalRate),
            BasalScheduleEntry(rate:  0.00, startTime: .hours(2), zeroBasalRate: Pod.nearZeroBasalRate),
            BasalScheduleEntry(rate:  0.15, startTime: .hours(3), zeroBasalRate: Pod.nearZeroBasalRate),
            BasalScheduleEntry(rate:  0.00, startTime: .hours(5), zeroBasalRate: Pod.nearZeroBasalRate),
            BasalScheduleEntry(rate:  0.20, startTime: .hours(7), zeroBasalRate: Pod.nearZeroBasalRate),
            BasalScheduleEntry(rate:  0.00, startTime: .hours(9), zeroBasalRate: Pod.nearZeroBasalRate),
            BasalScheduleEntry(rate:  0.25, startTime: .hours(11), zeroBasalRate: Pod.nearZeroBasalRate),
            BasalScheduleEntry(rate:  0.00, startTime: .hours(14), zeroBasalRate: Pod.nearZeroBasalRate),
            ]
    ...
    func testZeroBasalTest2() {
        let entries = [
            ...
            BasalScheduleEntry(rate:  0.00, startTime: .hours(2), zeroBasalRate: Pod.nearZeroBasalRate),
            BasalScheduleEntry(rate:  0.15, startTime: .hours(3), zeroBasalRate: Pod.nearZeroBasalRate),
            BasalScheduleEntry(rate:  0.25, startTime: .hours(7), zeroBasalRate: Pod.nearZeroBasalRate),
            BasalScheduleEntry(rate:  0.00, startTime: .hours(9), zeroBasalRate: Pod.nearZeroBasalRate),
            BasalScheduleEntry(rate:  0.25, startTime: .hours(11), zeroBasalRate: Pod.nearZeroBasalRate),
            BasalScheduleEntry(rate:  0.00, startTime: .hours(14), zeroBasalRate: Pod.nearZeroBasalRate),
            BasalScheduleEntry(rate:  0.30, startTime: .hours(17), zeroBasalRate: Pod.nearZeroBasalRate),
            ]
    ...
    func testZeroBasalTest4() {
        let entries = [
            ...
            BasalScheduleEntry(rate:  0.00, startTime: .hours(9), zeroBasalRate: Pod.nearZeroBasalRate),
            BasalScheduleEntry(rate:  0.25, startTime: .hours(11), zeroBasalRate: Pod.nearZeroBasalRate),
            BasalScheduleEntry(rate:  0.00, startTime: .hours(12), zeroBasalRate: Pod.nearZeroBasalRate),
            ]
